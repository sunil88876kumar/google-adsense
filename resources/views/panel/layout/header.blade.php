            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="primary-nav navbar-nav max-lg:py-4 max-lg:px-3">
                    ...
                    @if(Auth::user()->type == 'admin')
						...
						<li class="nav-item">
                            <a class="nav-link {{activeRoute('dashboard.admin.googleadsense.index')}}" href="{{route('dashboard.admin.googleadsense.index')}}" >
								<span class="nav-link-icon bg-navbar-icon-background text-navbar-icon-foreground group-hover/link:bg-navbar-icon-background-hover group-hover/link:text-navbar-icon-foreground-hover group-[&amp;.active]/link:bg-navbar-icon-background-active group-[&amp;.active]/link:text-navbar-icon-foreground-active">
									<svg stroke-width="1.5" class="size-navbar-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M12 12m-10 0a10 10 0 1 0 20 0a10 10 0 1 0 -20 0"></path><path d="M7 15v-4.5a1.5 1.5 0 0 1 3 0v4.5"></path><path d="M7 13h3"></path><path d="M14 9v6h1a2 2 0 0 0 2 -2v-2a2 2 0 0 0 -2 -2h-1z"></path></svg> 
								</span>
								<span class="flex items-center transition-[opacity,transform] nav-link-title grow">
									{{__('GoogleAdsense')}}
								</span>
