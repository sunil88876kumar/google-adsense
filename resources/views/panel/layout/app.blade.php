...
<body class="group/body">
	...
	<div class="page">
		...
		<div class="page-wrapper overflow-hidden">
            ...
            @if($good_for_now)
			@yield('content')
            @elseif(!$good_for_now and Route::currentRouteName()!= 'dashboard.admin.settings.general' and Route::currentRouteName() != 'dashboard.admin.googleadsense.index' and Route::currentRouteName() != 'dashboard.admin.googleadsense.googleAdsenseNewOrEdit')
